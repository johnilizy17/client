...
export default function Header() {
    ...
    return (<>
        ...
        <div className={menubar ? "lg:hidden  bg-white mt-5 ml-5 mr-5 z-50 w-screen" : "lg:hidden  pl-3  h-screen bg-white z-50 w-screen -mt-8 fixed"}>
            <div className="lg:hidden sm:flex items-center ">
                ...
                <div onClick={() => {
                    ...
                    {menubar ? <HiMenuAlt3 style={{ width: 50, height: 50 , marginRight:15 }} />
